...
from .krea2_studio import (
    NODE_CLASS_MAPPINGS as KREA2_STUDIO_CLASS_MAPPINGS,
    NODE_DISPLAY_NAME_MAPPINGS as KREA2_STUDIO_DISPLAY_NAME_MAPPINGS,
)
...
NODE_CLASS_MAPPINGS.update(KREA2_STUDIO_CLASS_MAPPINGS)
...
NODE_DISPLAY_NAME_MAPPINGS.update(KREA2_STUDIO_DISPLAY_NAME_MAPPINGS)
